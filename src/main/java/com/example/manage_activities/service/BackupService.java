...
public class BackupService {
    ...
    private Map<Integer, Integer> persistAndRemapRoles(List<Role> roles) {
        ...
        try {
            entityManager.createNativeQuery("ALTER TABLE roles ALTER COLUMN id INT NOT NULL").executeUpdate();
            for (Role role : roles) {
            ...
            entityManager.createNativeQuery("ALTER TABLE roles ALTER COLUMN id INT GENERATED BY DEFAULT AS IDENTITY").executeUpdate();
            entityManager.flush();
            entityManager.clear();
        } catch (Exception exception) {
